...
export default function DashboardSidebar({
    ...
    const NAVIGATION_ITEMS = [
        ...
        },
        {
            ...
            icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8"/><path d="M12 17v4"/><path d="M7 8l3 3-3 3"/><path d="M13 14h4"/></svg>,
        },
        {
    ...
    const renderNav = (closeMobile) => (
        <>
            ...
            <div className="mt-auto px-5 pb-4">
                <button 
                    onClick={onLogout}
                    className="flex items-center gap-2 text-sm text-[var(--muted)] hover:text-red-500 transition-colors w-full"
                >
